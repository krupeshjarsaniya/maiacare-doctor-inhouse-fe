 ...
 useEffect(() => {
    ...
    const handleSaveFertilityAssessment = async (data: FertilityAssessmentFormType) => {
        ...
        try {
            if (modalFormFertilityData?._id) {
                ...
                setModalFormFertilityData(res.data.data);
            } else {
                // ⭐ CREATE
    ...
    const handleSaveMedicalHistory = async (data: any) => {
        ...
        try {
            if (medicalHistoryFormData?._id) {
                ...
                setMedicalHistoryFormData(res.data.data);
            } else {
                // ➕ Create new record
                                            ...
                                            <Col sm={6}>
                                                <div className="d-flex flex-column gap-1">
                                                    ...
                                                    <span className="accordion-title-detail">
                                                        {formatForDateInput(modalFormFertilityData?.menstrualCycle?.lastPeriodDate)}
                                                    </span>
                                                </div>
                                            </Col>
  ...
  Consultation Review <span className="required-star">*</span>
                ...
                <Modal
                    ...
                    header={
                        !medicalHistoryFormData || Object.keys(medicalHistoryFormData).length === 0
                            ? "Add Medical History"
